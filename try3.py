...
@st.cache_data
def patient():
    patient = pd.read_csv('C:/Users/ys/Documents/TARUC/FYP/try/data/cohort/cohort_icu_readmission_30_I50.csv.gz', compression='gzip', error_bad_lines=False)
    return patient

@st.cache_data
def icd():
    icd = pd.read_csv('C:/Users/ys/Documents/TARUC/FYP/try/data/features/preproc_diag_icu.csv.gz', compression='gzip', error_bad_lines=False)
    return icd
